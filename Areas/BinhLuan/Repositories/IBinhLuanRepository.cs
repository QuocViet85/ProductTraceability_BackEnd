...
{
    public Task<List<BinhLuanModel>> LayNhieuBangSanPhamAsync(Guid sp_id, int soSao, int pageNumber, int limit);
    public Task<int> LayTongSoBangSanPhamAsync(Guid sp_id, int soSao);
